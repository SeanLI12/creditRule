function getParameterByName(name, url = window.parent.window.location.href) {
    name = name.replace(/[\[\]]/g, '\\$&');
  ...
  selectContainer.onchange=function(e){
    ...
    var dropdownButton = document.getElementById("dropdown-button");
      ...
      window.parent.parent.postMessage({
          topic: "changeTitle",
          data: {title:"",pageName:document.getElementById(itemID).textContent},
      }, "*");

      const newLocation =
        "./sports/" + itemID + ".html?v=" + Date.now();
